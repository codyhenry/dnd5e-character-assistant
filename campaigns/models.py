...
class Campaign(models.Model):
    if TYPE_CHECKING:
        # Reverse relation from CampaignMembership.campaign.
        memberships: Any
        # Reverse relations generated by related_name values.
        character_builds: Any
        rulesets: Any
        # Forward FK relation and Django-generated *_id field.
        active_ruleset: Any
        active_ruleset_id: int | None
        _previous_active_ruleset_id: int | None
